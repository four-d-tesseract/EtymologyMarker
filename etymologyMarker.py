...
def lookupInDictionary(formattedList, WordCountList):
    ...
    while (x < len(formattedList)):
        ...
        if allWords.get(y) == 'Anglo':
            ...
            splitString[x] = '<span style="background-color: #FFFF00">' + splitString[x] + '</span>'
            WordCountList[2] = WordCountList[2] + 1
        elif allWords.get(y) == 'Latin':
            splitString[x] = '<span style="background-color: #FF0000">' + splitString[x] + '</span>'
...
def removeExtraHTML(formattedList):
    ...
    while (x < len(formattedList)):
        ...
        if allWords.get(y) == 'Anglo' and allWords.get(z) == 'Anglo':
            ...
            splitString[x] = splitString[x].replace('<span style="background-color: #FFFF00">', '')
            splitString[x-1] = splitString[x-1].replace('</span>', '')
        elif allWords.get(y) == 'Latin' and allWords.get(z) == 'Latin':
            splitString[x] = splitString[x].replace('<span style="background-color: #FF0000">', '')
            splitString[x-1] = splitString[x-1].replace('</span>', '')
...
markedUp.write('<p>' + 'Dark green words have some other Germanic origin (Old Norse, Scandinavian, German, Dutch).' + '</p>')
markedUp.write('<p>' + 'Yellow words have a French origin.' + '</p>')
markedUp.write('<p>' + 'Red words have a Latin origin.' + '</p>')
markedUp.write('<p>' + 'Pink words have an Arabic origin.' + '</p>')
markedUp.write('<p>' + 'Blue words have a Greek origin.' + '</p>')
